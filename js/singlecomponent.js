...
function singleCreatorFunc(hh,cId,index){  
            ...
            for (let i = 0; i < allnum[index] ; i++) {
                ...
                <div>
                    <img src="images/iteams/${allcatName[index]}/${aliasName[index]}${i+1}.jpg" class="cat-img" alt="Mohie FineArt's Product Image" data-bs-toggle="modal" data-bs-target="#imgmodal" onclick="document.getElementById(mod_Id).setAttribute('src','images/iteams/${allcatName[index]}/${aliasName[index]}${i+1}.jpg');">
                </div>
                <div class="cat-content text-center p-3">
                <h3 class="cat-name goldencolor"><a href="#"><img src="images/navlogo.png"></a></h3>
                </div>
                </div>
                `;
